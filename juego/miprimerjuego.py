...
from camara import Webcam
from enemigo import Enemy
from interaccion import *
from fondodejuego import Background
import globals
import random
...
class Game:
    def __init__(self):
        ...
        pygame.init()
        pygame.display.set_caption("Prueba Si funciona")
    ...
    def initialize(self):
        ...
        self.level = 1
        self.level_duration = 15000  # 15 segundos en milisegundos
    ...
    def update(self, delta_time):
        ...
        if self.lost or not self.started:
            ...
            if level_time >= self.level_duration:
                # Incrementar el nivel
                self.level += 1

                # Reiniciar el tiempo de inicio del nivel y el temporizador de enemigos
                self.start_time = pygame.time.get_ticks()
    ...
    def process_collisions(self):
        # Colisiones para este juego las hacemos con máscaras
    ...
    def render(self):
        ...
        text_level = self.font.render('Nivel: ' + str(self.level), True, (255, 255, 255))
        levelTextRect = text_level.get_rect()
        levelTextRect.bottom = SCREEN_HEIGHT - 5
        levelTextRect.right = SCREEN_WIDTH - 5
        self.screen.blit(text_level, levelTextRect)
    ...
    def detect_head_movement(self, top, bottom):
        ...
        # Angulo de detección de 70 a 110 (-1 a 1)
        min_degrees = 70
        max_degrees = 110
    ...
    def render_camera(self):
        ...
        face_surf = pygame.image.frombuffer(self.webcam_image, (int(self.webcam.width()), int(self.webcam.height())),
                                            "BGR")
